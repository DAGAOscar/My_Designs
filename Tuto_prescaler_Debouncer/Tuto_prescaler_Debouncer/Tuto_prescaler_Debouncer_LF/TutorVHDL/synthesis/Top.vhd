...
entity Debouncer is
  port (
    \DELAY_reg[2]_0\ : out STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of Prescaler is
  ...
  attribute ADDER_THRESHOLD of \DIVIDER_reg[0]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \DIVIDER_reg[12]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \DIVIDER_reg[16]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \DIVIDER_reg[20]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \DIVIDER_reg[24]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \DIVIDER_reg[4]_i_1\ : label is 11;
  attribute ADDER_THRESHOLD of \DIVIDER_reg[8]_i_1\ : label is 11;
begin
  \eqOp__25\ <= \^eqop__25\;
...
\Q_INT[3]_i_10\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
