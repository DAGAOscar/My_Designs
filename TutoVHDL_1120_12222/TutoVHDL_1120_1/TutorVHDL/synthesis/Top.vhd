...
architecture STRUCTURE of Prescaler is
  ...
  signal DIVIDER_reg : STD_LOGIC_VECTOR ( 19 downto 0 );
  ...
  signal \NLW_DIVIDER_reg[16]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
begin
...
\DIVIDER_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_DIVIDER_reg[16]_i_1_CO_UNCONNECTED\(3),
...
\Q_INT[3]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFBF"
    )
        port map (
...
\Q_INT[3]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\Q_INT[3]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\Q_INT[3]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\Q_INT[3]_i_8\: unisim.vcomponents.LUT6
    generic map(
